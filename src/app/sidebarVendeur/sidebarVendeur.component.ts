...
@Component({
  selector: 'app-sidebarVendeur',
  templateUrl: './sidebarVendeur.component.html',
  styleUrls: ['./sidebarVendeur.component.css']
})


export class sidebarVendeurComponent implements OnInit {
